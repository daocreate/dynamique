...
class DemoAppDataSeeder extends Seeder
{
    ...
    private function userData(){
        $created_by = 1;
        $created_at = Carbon::now(env('APP_TIMEZONE','Africa/Douala'));
    ...
    private function instituteSettingsData()
    {
        ...
        $data['address'] = 'Logements sociaux,Ngaoundéré';
    ...
    private function academicCalendarData() {
        ...
        $data = [
            [
                ...
                'is_holiday' => '1',
                'is_exam' => '0',
                'description' => 'Declaration of Independence from Cameroon in 1960',
                'created_by' => $created_by,
                'created_at' => $created_at
            ],[
                'title' => "1st Term Exam",
    ...
    private function sectionData() {
        $created_by = 1;
        $created_at = Carbon::now(env('APP_TIMEZONE','Africa/Douala')); //Asia/Dhaka
    ...
    private function smsAndEmailTemplateData() {
        ...
        $data = [
            ...
            [
                ...
                'role_id' => AppHelper::USER_STUDENT,
                'content' => "Dear Parents your child (Name-{{name}},Class-{{class}},Roll-{{roll_no}}) is absent from school on {{date}}. Head master, GSBD.",
                'created_by' => $created_by,
                'created_at' => $created_at
            ],[
            ...
            [
                ...
                'type' =>  1, //AppHelper::TEMPLATE_TYPE
                'role_id' => AppHelper::USER_TEACHER,
                'content' => "Dear {{name}}, You are absent from school on {{date}}. Head master, GSBD.",
                'created_by' => $created_by,
                'created_at' => $created_at
            ],[

...
return [
    ...
    'select_religion_type'                  => 'select religion type',
    'select_blood_type'                     => 'select blood group type',
    'holiday'                               => 'Holiday',
    'end_date'                              => 'End Date',
    'gender'                                => 'Gender',
    'blood_group'                           => 'Blood Group',
    'nationality'                           => 'Nationality',
    'extra_curricular_activity'             => 'Extra Curricular Activity',
    ...
    'set_class_that_student_belongs_to'     => 'Set class that student belongs to',
    'class_canot_be_change'                 => 'Class can\'t be change.',
    'set_section_that_student_belongs_to'   => 'Set section that student belongs to',
    'shift'                                 => 'Shift',
    'set_class_shift'                       => 'Set class shift',
    'elective_4th_subject'                  => 'Elective/4th subject',
    'board_registration'                    => 'Board Registration No.',
    'year_canot_be_change'                  => 'Year can\'t be change.',
    'select_academic_year'                  => 'Set academic year',
    'alternative_elective_4th_subject'      => 'Alternate Elective/4th subject',
    'if_student_change_4th_subject'         => 'If student change 4th subject with other subject,then select the 4th subject and alternate subject.Otherwise don\'t select the alternate subject.',
    'house_name'                            => 'House Name',
    'if_student_group_by_its_hostel_name'   => 'if student group by its hostel name',
    'leave_blank_if_not_needed'             => 'leave blank if not needed',
    'fee_info'                              => 'Fee Info :',
    'access_info'                           => 'Access Info :',
    'leave_blank_if_not_need_create_user'   => 'leave blank if not need to create user',
    'leave_as_it_is_if_not_need_user'       => 'Leave as it is, if not need user',
